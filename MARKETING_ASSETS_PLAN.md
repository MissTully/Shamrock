...
service that builds **fully membership-driven websites for krewes**. Every asset is
tied back to real, working features of the Krewe of Shamrock site so your marketing
is grounded in a live product you can point to — not promises.

**Your flagship proof:** [krewe-of-shamrock.vercel.app](https://krewe-of-shamrock.vercel.app)
— a public heritage/marketing site *and* a private, gamified members portal running on
...
## 2. The asset inventory (what to actually produce)

Grouped by function. Each item lists **what it is**, **why it matters**, and **priority**
(🟢 launch-critical · 🟡 soon · ⚪ later). A phased build order is in §5.
...
| **Email signature + business card** | Contact, portfolio link, "Book a demo" CTA | 🟡 |

### 2.2 Portfolio & proof (built on Shamrock)

| Asset | Notes | Priority |
|-------|-------|----------|
| **Flagship case study** | 1–2 page story: the problem (spreadsheets, missed dues, low turnout) → the build → the result. Screens + quotes | 🟢 |
| **Live demo site** | A "sandbox" krewe (generic branding) prospects can click through, including a members-portal login with seeded data | 🟢 |
| **Annotated screenshot library** | Clean shots of: home, members directory, Craic Cup leaderboard, raffle manager, event RSVP, officer dashboard, dues view | 🟢 |
| **2–3 min demo video / screen recording** | Voiceover walkthrough of public site → member login → portal features (the .mp3 theme in the repo can score it) | 🟢 |
| **Feature GIFs** | Short loops of the "wow" moments: earning Clovers, RSVPing, ranking up, running a raffle | 🟡 |
| **Before/after narrative** | "How a krewe ran on paper vs. how it runs now" — great for social carousels | 🟡 |

### 2.3 Sales collateral

| Asset | Notes | Priority |
|-------|-------|----------|
| **One-page service sheet (PDF)** | The offer, 3 tiers, top features, your face/name, CTA. Leave-behind + email attachment | 🟢 |
| **Pitch deck (8–12 slides)** | Problem → solution → live features → tiers/pricing → proof → next steps. For krewe boards | 🟢 |
...
| **Feature checklist / comparison** | Tick-box of what each tier includes (see §3 messaging bank) | 🟡 |
...
### 2.4 Your own marketing website (the studio site)

| Asset | Notes | Priority |
|-------|-------|----------|
| **Landing page** | Hero + value props + live-demo link + feature grid + tiers + "Book a demo" form | 🟢 |
| **Portfolio / case-study page** | The Shamrock story, embedded demo video, screenshots | 🟢 |
...
| **Lead magnet** | Free download: "The Krewe Digital Readiness Checklist" or "10 Ways a Website Grows Your Krewe" (gates emails) | 🟡 |

> Meta-selling point: your own site *is* a portfolio piece. Build it on the same
> stack (static + Supabase form) so you can say "this runs on exactly what your krewe
> gets."

### 2.5 Advertising & social assets

| Asset | Notes | Priority |
|-------|-------|----------|
| **Social profiles** | Instagram + Facebook (where krewes live) + optionally TikTok; consistent handle/branding | 🟢 |
| **Launch post + pinned intro** | "I build websites that run krewes. Here's one." + demo video | 🟢 |
| **Content templates (10–15)** | Feature spotlights, before/after, tip carousels, testimonial cards — reusable Canva templates | 🟡 |
...
| **Cold outreach email/DM templates** | 3 variants: to captains, to newer krewes, to krewes with a weak/old site | 🟡 |
| **Email nurture sequence (3–5 emails)** | For lead-magnet subscribers → demo → offer | ⚪ |
...
| **Client CRM / pipeline tracker** | Simple spreadsheet or CRM: lead → demo → proposal → build → live → retainer | 🟢 |

---

## 3. Feature-to-benefit messaging bank

The core of your copy. Translate each real feature into a benefit a krewe captain
*feels*. Use these lines verbatim in the deck, one-pager, ads, and site.

| Real feature (in the Shamrock build) | What you say to a krewe |
|--------------------------------------|-------------------------|
...
## 5. Production plan (phased — value first)

Build the smallest set that lets you pitch, then expand.

**Phase 1 — "I can pitch tomorrow" (launch-critical 🟢):**
1. Business name, tagline, logo, colors.
2. Polish the Shamrock demo + stand up a generic live demo with seeded member logins.
3. Screenshot library + 2–3 min demo video.
4. One-page service sheet (PDF) + pitch deck + pricing sheet.
5. Flagship case study.
6. Intake questionnaire + a simple pipeline tracker.
7. Studio landing page with a "Book a demo" form.

**Phase 2 — "I can market & close" (🟡):**
8. Proposal/SOW template + contract + invoice templates.
9. Social profiles + launch post + 10–15 content templates.
10. Onboarding kit + content-collection template.
11. FAQ + feature comparison sheet.
12. Cold outreach templates.

**Phase 3 — "I can scale" (⚪):**
13. Ad creative sets + short-form video + paid campaigns.
14. Lead magnet + email nurture sequence.
15. Print collateral for events.
16. A repeatable "starter template" build so each new krewe site is faster to ship.

---

## 6. Tools to produce these assets

You have connectors available in this workspace that can generate much of the above:

- **Canva** — logo, one-pager, pitch deck, social/ad templates, flyers, quote cards.
- **Google Drive / Docs** — proposal, SOW, contract, onboarding kit, FAQ, intake form.
- **This repo (Shamrock)** — screenshots, demo video source, and the theme `.mp3`
  already here for scoring the demo video.
...
Say the word and I can start generating any of these — e.g. draft the pitch deck, the
one-page service sheet, the case study, or the intake questionnaire next.
...
- [ ] Stand up a clickable generic demo (public + member login)
- [ ] Record the 2–3 min walkthrough video
- [ ] Build the screenshot library
- [ ] Write the flagship Shamrock case study
- [ ] Create the one-pager, pitch deck, and pricing sheet
- [ ] Publish the studio landing page with a "Book a demo" form
